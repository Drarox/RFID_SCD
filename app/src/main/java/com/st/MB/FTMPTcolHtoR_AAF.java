...
public class FTMPTcolHtoR_AAF extends FTMPTColHtoR {

    public FTMPTcolHtoR_AAF() {
        // TODO Auto-generated constructor stub
        //super();
    }

    public FTMPTcolHtoR_AAF(MBFct mbFctSimple) {
        // TODO Auto-generated constructor stub
        super(mbFctSimple);
    }
    ...
    public void initProtocol(int max_tranceive_data_available) {
        ...
        this.mHTProtocolStepsDescr.put((byte) 0, ProtocolStatus.MB_PTL_Acknowledge);
        this.mHTProtocolStepsDescr.put((byte) 1, ProtocolStatus.MB_PTL_Answer);
        this.mHTProtocolStepsDescr.put((byte) 2, ProtocolStatus.MB_PTL_Finished);

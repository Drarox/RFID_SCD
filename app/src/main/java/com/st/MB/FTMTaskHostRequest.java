...
public class FTMTaskHostRequest extends FTMTaskRequestResponse {

    public FTMTaskHostRequest() {
        // TODO Auto-generated constructor stub
        super();
        this.mThreadWaitingTime = 100;
    }
    ...
    protected void onPostExecute(final Void unused) {
        ...
        FTMPTColGeneric.ProtocolStatus step = mProtocol.getCurrentProtocolStep();

        this.mEndTime_ms = System.currentTimeMillis();
        if (step != FTMPTColGeneric.ProtocolStatus.MB_PTL_Finished && step !=null &&

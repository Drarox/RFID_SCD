...
import java.util.Random;
    ...
    public class FTMUseCaseImageUpdate extends FTMUseCaseGen implements MBTransferListenerDataSent {
...
/*    private MBGenericTaskRequestResponse stask;
    ...
    public FTMUseCaseImageUpdate(int size) {
        // TODO Auto-generated constructor stub
        FWsize = size;
        // showFileChooser();
    ...
    public FTMUseCaseImageUpdate(byte[] bufferFile, long m_CRC2, MBFct Fct) {
        // TODO Auto-generated constructor stub
        mpl = bufferFile;
        m_CRC = m_CRC2;
